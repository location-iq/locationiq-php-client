...
class SearchApi
{
     ...
     * @param  int $matchquality Returns additional information about quality of the result in a matchquality object. Read more Defaults to 0 [0,1] (optional)
     ...
     * @return \LocationIq\Model\Location[]|\LocationIq\Model\Error|\LocationIq\Model\Error|\LocationIq\Model\Error|\LocationIq\Model\Error|\LocationIq\Model\Error|\LocationIq\Model\Error
     */
    public function search($q, $format, $normalizecity, $addressdetails = null, $viewbox = null, $bounded = null, $limit = 10, $accept_language = null, $countrycodes = null, $namedetails = null, $dedupe = null, $extratags = null, $statecode = null, $matchquality = null, $postaladdress = null)
    {
        list($response) = $this->searchWithHttpInfo($q, $format, $normalizecity, $addressdetails, $viewbox, $bounded, $limit, $accept_language, $countrycodes, $namedetails, $dedupe, $extratags, $statecode, $matchquality, $postaladdress);
        return $response;
    }
     ...
     * @throws \LocationIq\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \LocationIq\Model\Location[]|\LocationIq\Model\Error|\LocationIq\Model\Error|\LocationIq\Model\Error|\LocationIq\Model\Error|\LocationIq\Model\Error|\LocationIq\Model\Error, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchWithHttpInfo($q, $format, $normalizecity, $addressdetails = null, $viewbox = null, $bounded = null, $limit = 10, $accept_language = null, $countrycodes = null, $namedetails = null, $dedupe = null, $extratags = null, $statecode = null, $matchquality = null, $postaladdress = null)
    {
        $request = $this->searchRequest($q, $format, $normalizecity, $addressdetails, $viewbox, $bounded, $limit, $accept_language, $countrycodes, $namedetails, $dedupe, $extratags, $statecode, $matchquality, $postaladdress);
     ...
     */
    public function searchAsync($q, $format, $normalizecity, $addressdetails = null, $viewbox = null, $bounded = null, $limit = 10, $accept_language = null, $countrycodes = null, $namedetails = null, $dedupe = null, $extratags = null, $statecode = null, $matchquality = null, $postaladdress = null)
    {
        return $this->searchAsyncWithHttpInfo($q, $format, $normalizecity, $addressdetails, $viewbox, $bounded, $limit, $accept_language, $countrycodes, $namedetails, $dedupe, $extratags, $statecode, $matchquality, $postaladdress)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchAsyncWithHttpInfo($q, $format, $normalizecity, $addressdetails = null, $viewbox = null, $bounded = null, $limit = 10, $accept_language = null, $countrycodes = null, $namedetails = null, $dedupe = null, $extratags = null, $statecode = null, $matchquality = null, $postaladdress = null)
    {
        $returnType = '\LocationIq\Model\Location[]';
        $request = $this->searchRequest($q, $format, $normalizecity, $addressdetails, $viewbox, $bounded, $limit, $accept_language, $countrycodes, $namedetails, $dedupe, $extratags, $statecode, $matchquality, $postaladdress);
     ...
     */
    protected function searchRequest($q, $format, $normalizecity, $addressdetails = null, $viewbox = null, $bounded = null, $limit = 10, $accept_language = null, $countrycodes = null, $namedetails = null, $dedupe = null, $extratags = null, $statecode = null, $matchquality = null, $postaladdress = null)
    {
        ...
        if ($matchquality !== null) {
            $queryParams['matchquality'] = ObjectSerializer::toQueryValue($matchquality);
        }
        // query params
